...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{frame}[fragile, hvid]
		\frametitle{WSDL: contratos estrictos}
			\vfill
En la práctica, WSDL funciona como un contrato estricto: las herramientas pueden generar código cliente y servidor a partir del documento WSDL, y los mensajes se validan contra los esquemas definidos.
\\~\\
			\vfill
	\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
