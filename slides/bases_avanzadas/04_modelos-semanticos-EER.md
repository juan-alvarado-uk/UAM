...
***
![EER_simbologia](https://i.ibb.co/7xnPgPYS/EER-simbologia.png)
...
![EER_disjunta_total.png](https://i.ibb.co/YTDywxsZ/EER-disjunta-total.png)
...
**Ejemplo**
![EER-Sensores-Lecturas.png](https://i.ibb.co/hF0s1VtY/EER-Sensores-Lecturas.png)
...
![EER_Multivaluado.png](https://i.ibb.co/rGQgq89h/EER-Multivaluado.png)
...
![EER_tecnicos-proyectos-equipos-Agregacion.png](https://i.ibb.co/jkYybdkv/EER-tecnicos-proyectos-equipos-Agregacion.png)
...
![EER_equivalente.png](https://i.ibb.co/0VDGMXMv/EER-equivalente.png)
